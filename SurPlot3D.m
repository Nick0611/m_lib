...
% pcolor(X,Y,Z);shading interp%伪彩色图
% figure('name','等高线图'),contourf(X,Y,Z) %等高线图
% figure('name','三维曲面'),surf(X,Y,Z)%三维曲面
figure('name','网格图'),mesh(X,Y,Z),hold on,scatter3(x,y,z,'filled');%网格图
